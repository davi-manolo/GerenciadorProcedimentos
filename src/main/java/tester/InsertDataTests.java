...
public class InsertDataTests {
    ...
    private ProcedureTypeDAO type = new ProcedureTypeTesterImp();
    private ServiceProcedureDAO sp = new ServiceProcedureTesterImpl();
    
    public InsertDataTests() {
        ...
        try {
            ...
            Logger.getLogger(InsertDataTests.class.getName()).log(Level.SEVERE, null, ex);
        }
