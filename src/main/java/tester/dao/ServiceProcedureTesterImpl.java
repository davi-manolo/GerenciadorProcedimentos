...
import tester.database.ProcedureManagerTesterDB;
...
public class ServiceProcedureTesterImpl implements ServiceProcedureDAO {
    
    private ObservableList<ServiceProcedureModel> list = ProcedureManagerTesterDB.getServiceProcedureModelList();
