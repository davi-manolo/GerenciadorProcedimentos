...
public class ProcedureTypeTesterImp implements ProcedureTypeDAO {
    
    private ObservableList<ProcedureTypeModel> list = ProcedureManagerTesterDB.getTypeModelList();
